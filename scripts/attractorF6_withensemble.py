...
num_trajectories_fw = 50
forward_initial_conditions = np.random.uniform(-3, 3, size=(num_trajectories_fw, 3))

years = 6 #make sure the system converges on the attractor
T = 73 * years
...
# %%
#store only the last 1000 points of each trajectory
...
# to better visualize the attractor select the last 50 points of each trajectory
